  ...
  public class BundleConfig
  {
    ...
    public static void RegisterBundles(BundleCollection bundles)
    {
      ...
      bundles.Add(new ScriptBundle("~/bundles/backend-js").Include(
                  ...
                  "~/Content/backend/js/BI-*", //This entry will catch all new modules named BI-xxxxx.js, where xxxxx stands for the name of the new module. e.g. BI-news.js
      ...
      bundles.Add(new StyleBundle("~/bundles/backend-css").Include(
                  ...
                  "~/Content/backend/css/BI-*" //This entry will catch all new modules named BI-xxxxx.css, where xxxxx stands for the name of the new module. e.g. BI-news.css
                  ));
      ...
      bundles.Add(new ScriptBundle("~/bundles/frontend-js").Include(
                  "~/Scripts/jquery.unobtrusive*",
                   ...
                   "~/Scripts/url.js",
                   "~/Content/shared/js/jquery.*", //This entry will catch all new jquery plugins named jquery.xxxxx.js, where xxxxx stands for the name of the new plugin. e.g. jquery.slide.js
                  "~/Content/frontend/js/BI-*", //This entry will catch all new modules named BI-xxxxx.js, where xxxxx stands for the name of the new module. e.g. BI-news.js
                   "~/Content/shared/js/ays-beforeunload-shim.js"
                   ));
      ...
      bundles.Add(new StyleBundle("~/bundles/frontend-css").Include(
                  ...
                  "~/Content/frontend/css/BI-*" //This entry will catch all new modules named BI-xxxxx.css, where xxxxx stands for the name of the new module. e.g. BI-news.css
                  ));

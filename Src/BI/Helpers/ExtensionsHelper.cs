    ...
    public static class ExtensionsHelper
    {
        ...
        public static string GetStringFromResource(this string stringResourceKey)
        {
            ...
            if (result.IsEmptyOrWhiteSpace())
            {
                ...
                List<Type> resourceSources = Assembly.GetExecutingAssembly().GetTypes().Where(t => t.Namespace == "VASJ.BI.Resources" && t.Name != "Strings").ToList<Type>();
